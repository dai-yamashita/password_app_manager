...
$config['DX_salt'] = '';// Just leave it blank or else the admin cannot login..
...
$config['DX_deny_uri'] = 'admin/auth/deny/';
$config['DX_login_uri'] = 'admin/auth/login/';
$config['DX_banned_uri'] = 'admin/auth/banned/';
$config['DX_activate_uri'] = 'admin/auth/activate/';
$config['DX_reset_password_uri'] = 'admin/auth/reset_password/';
