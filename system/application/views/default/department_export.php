<div class="title title-spacing">
    <h2>Export groups </h2>
    <span style="color:#000; font-size:14px">Export groups in <b><?= $exportfmt?></b> format.</span>        
</div>

<?php !empty($flash) ? flash($flash) : '' ?>

<form action="<?= site_url( "admin/department/export/$exportfmt") ?>" name="exportform" method="post" id="importfrm"  >
...
Output format: <em class="em2" >month-day-year-groups.csv</em>
    </p></td>
  </tr>
  <tr>
