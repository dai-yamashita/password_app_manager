<div class="title title-spacing">
    <h2>Export domain access</h2>
    <span style="color:#000; font-size:14px">Export domain access in <b><?= $exportfmt?></b> format.</span><br /><br />
 </div>
<?php !empty($flash) ? flash($flash) : '' ?>
<form action="<?= site_url( "admin/domain/export/$exportfmt") ?>" name="exportform" method="post" id="importfrm"  >
