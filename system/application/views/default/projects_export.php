<div class="title title-spacing">
    ...
    <span style="color:#000; font-size:14px">Export projects in <b><?= $exportfmt?></b> format.</span>            
</div>
<?php !empty($flash) ? flash($flash) : '' ?>
<form action="<?= site_url( "admin/project/export/$exportfmt") ?>" name="exportform" method="post" id="importfrm"  >
...
<table width="98%" border="1" class="csvoptable" >
  <tr>
    ...
    Output format: <em class="em2" >month-day-year-projects.csv</em></p></td>
  </tr>
  <tr>
