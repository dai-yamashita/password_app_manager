<div class="title title-spacing">
    <h2>Export personal domain access</h2>
    <span style="color:#000; font-size:14px">Export personal domain access in <b><?= $exportfmt?></b> format.</span><br /><br />
 </div>
<?php !empty($flash) ? flash($flash) : '' ?>
<form action="<?= site_url( "admin/mydomain/export/$exportfmt") ?>" name="exportform" method="post" id="importfrm"  >
...
Output format: <em class="em2" >month-day-year-domainaccess.csv</em>
    </p></td>
  </tr>
  <tr>
