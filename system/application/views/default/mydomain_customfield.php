...
<h2>Add custom field in in your personal domain access</h2>
</div>
...
?>
<form action="<?php echo site_url('admin/mydomain/customfield') ?>" method="post" >
<ul>
    <li>
...
?>
  <tr class="<?= (++$alt%2 == 0) ?  'alt' : '' ?>" >
    ...
    <td>
      ...
      <a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Delete" href="<?php echo site_url("admin/mydomain/deletefield/$id") ?>" onclick="return confirm('Are you sure you want to delete?')" >
