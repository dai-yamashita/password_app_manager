...
<h2>Step 3</h2>
<a href="<?= site_url("admin/project/import_step/csv/step/2")?>" >&laquo; Back to step2</a>
</div>
<?php
 ?>
<form method="post" action="<?= site_url( "admin/project/import_step/csv/step/3") ?>" enctype="multipart/form-data" >
<div class="hastable"  >
...
?> 
  ...
  <tr>
    ...
    <td width="46%"><?= isset($imported_csvdata[$n]['project']) ? $imported_csvdata[$n]['project'] : '&nbsp;' ?></td>
