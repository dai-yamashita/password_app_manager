...
<h2>Step 2</h2>
<a href="<?= site_url("admin/mydomain/import_step/csv/step/1")?>" >&laquo; Back to step1</a>
</div>
<?php
 ?>
<form method="post" action="<?= site_url( "admin/mydomain/import_step/csv/step/2") ?>" enctype="multipart/form-data" >
